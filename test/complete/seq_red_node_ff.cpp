// pipe(source_vec_stage,reduce_vec_double_stage,drain_stage)
...
int main( int argc, char* argv[] ) {
	...
	pipe.add_stage(&_reduce_vec_double_stage);
	pipe.add_stage(&_drain_stage);
	
	
	parameters::sequential = false;
	utils::write("pipe(source_vec_stage,reduce_vec_double_stage,drain_stage)", "./res_ff.txt");

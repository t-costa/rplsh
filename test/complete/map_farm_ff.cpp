// pipe(source_vecpair_stage,map(farm(map_vecpair_vec_stage) with [ nw: 1]) with [ nw: 1],drain_vec_stage)
...
int main( int argc, char* argv[] ) {
	...
	utils::write("pipe(source_vecpair_stage,map(farm(map_vecpair_vec_stage) with [ nw: 1]) with [ nw: 1],drain_vec_stage)", "./res_ff.txt");

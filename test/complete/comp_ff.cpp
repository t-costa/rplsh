// pipe(source_vecpair_stage,comp(map_vecpair_vecpair_stage,map_vecpair_vec_stage),drain_vec_stage)
...
int main( int argc, char* argv[] ) {
	...
	utils::write("pipe(source_vecpair_stage,comp(map_vecpair_vecpair_stage,map_vecpair_vec_stage),drain_vec_stage)", "./res_ff.txt");

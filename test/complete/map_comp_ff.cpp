// pipe(source_vecpair_stage,map(comp(map_vecpair_vec_stage,map_vec_vec_stage)) with [ nw: 1],drain_vec_stage)
...
int main( int argc, char* argv[] ) {
	...
	utils::write("pipe(source_vecpair_stage,map(comp(map_vecpair_vec_stage,map_vec_vec_stage)) with [ nw: 1],drain_vec_stage)", "./res_ff.txt");

// pipe(source_vec_stage,reduce(farm(reduce_vec_double_stage) with [ nw: 1]) with [ nw: 1],drain_stage)
...
int main( int argc, char* argv[] ) {
	...
	utils::write("pipe(source_vec_stage,reduce(farm(reduce_vec_double_stage) with [ nw: 1]) with [ nw: 1],drain_stage)", "./res_ff.txt");

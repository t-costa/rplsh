// pipe(source_vec_stage,map_vec_vec_stage,drain_vec_stage)
...
int main( int argc, char* argv[] ) {
	...
	pipe.add_stage(&_map_vec_vec_stage);
	...
	utils::build_json(0, par_time, par_degree, "pipe(source_vec_stage,map_vec_vec_stage,drain_vec_stage)");
	return 0;

...
int main( int argc, char* argv[] ) {
	...
	// farm's worker 2
	dc_fibonacci dc_stage1;
	ff_DC<utils::elem_type, utils::elem_type> _dc0_1(
		[&](const utils::elem_type& in, std::vector<utils::elem_type>& in_vec) {
	...
	// farm's worker 3
	dc_fibonacci dc_stage2;
	ff_DC<utils::elem_type, utils::elem_type> _dc0_2(
		[&](const utils::elem_type& in, std::vector<utils::elem_type>& in_vec) {
	...
	// farm's worker 4
	dc_fibonacci dc_stage3;
	ff_DC<utils::elem_type, utils::elem_type> _dc0_3(
		[&](const utils::elem_type& in, std::vector<utils::elem_type>& in_vec) {

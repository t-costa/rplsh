// farm(comp(source_vec_stage,seq_vec_vec_stage,drain_vec_stage)) with [ nw: 1]
...
int main( int argc, char* argv[] ) {
	// worker mapping 
	const char worker_mapping[] = "0,1,1,1,2";
	...
	std::cout << "Spent: " << farm.ffTime() << " msecs" << std::endl;
